...
const Home = () => {
  ...
  return(
    ...
    <div className='bg-[#1c1c1c] h-[15%] rounded flex flex-col justify-around'>
        <div onClick={()=>nav('/')} className='flex items-center gap-3 pl-8 cursor-pointer'>
         ...
         <div className='flex items-center gap-3 pl-8 cursor-pointer'>
            <img className='w-6 text-black'src={assets.search_icon}></img>
            <p className='font-bold text-white'>Search</p>
        </div>
        
    </div>
    <div className='bg-[#1c1c1c] h-[85%] rounded'>
        ...
        <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4' >
            <h1>Find some podcast to allow</h1>
